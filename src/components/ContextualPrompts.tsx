        ...
        {isLoading ? (
          ...
          suggestions.map((suggestion, idx) => (
            <button
              ...
              className="text-left px-4 py-3 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl hover:border-emerald-500 dark:hover:border-emerald-500 transition-colors group flex items-start gap-3 shadow-sm"
            >
              <div className="mt-0.5 bg-emerald-50 dark:bg-emerald-500/10 p-1.5 rounded-lg text-emerald-600 dark:text-emerald-400">
