          ...
          {loading ? (
            ...
            <div className="py-16 text-center space-y-4 max-w-sm mx-auto">
              ...
              <div>
                ...
                <p className="text-xs text-neutral-400 mt-1 leading-relaxed mb-6">
                ...
                <button
                  ...
                  className="px-6 py-2.5 rounded-xl text-xs font-semibold bg-white text-black hover:bg-neutral-200 transition-all inline-flex items-center gap-2 justify-center mx-auto"
                >
