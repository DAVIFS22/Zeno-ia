...
export const ZENO_MODELS_CONFIG: Record<ModelType, ModelConfig> = {
  ...
  grok: {
    ...
    badge: 'xAI',
    description: 'Versão de estabilidade e precisão do xAI com Grok 2.',
    category: 'think',
    color: '#0084DF',
    systemPrompt: 'Você é ZENO Grok, uma faceta intelectual avançada do ZENO.',
    temperature: 0.7,
    top_p: 0.95,
    top_k: 50,
    frequencyPenalty: 0.0,
  ...
  'grok-4.6': {
    ...
    apiModel: 'grok-2-latest',
    badge: 'xAI Grok',
    description: 'Potência cognitiva de ponta da xAI: raciocínio avançado, respostas diretas, humor perspicaz e excelência técnica com Grok 2.',
    category: 'think',
    color: '#0084DF',
    systemPrompt: 'Você é ZENO Grok, uma faceta intelectual avançada do ZENO potencializada pela arquitetura Grok da xAI. Você combina inteligência afiada, raciocínio lógico rigoroso, capacidade de análise profunda e respostas diretas e precisas.',
    temperature: 0.7,
    top_p: 0.95,
    top_k: 50,
    frequencyPenalty: 0.0,
    ...
    maxOutputTokens: 8192,
    priority: 9,
    tools: ['Chat', 'Memória', 'Raciocínio', 'Visão', 'Gerador de Imagens'],
    blockedTools: [],
    permissions: ['chat:read', 'chat:write', 'memory:read', 'reasoning:execute', 'image:generate'],
    capabilities: {
      memory: true,
