...
export const ZENO_MODELS_CONFIG: Record<ModelType, ModelConfig> = {
  ...
  grok: {
    ...
    badge: 'xAI',
    description: 'Versão de estabilidade anterior do xAI.',
    category: 'think',
    color: '#0084DF',
  ...
  'grok-4.6': {
    ...
    apiModel: 'grok-4.6',
    badge: 'xAI Grok',
    description: 'Potência cognitiva de ponta da xAI: raciocínio avançado, respostas diretas, humor perspicaz e excelência técnica com Grok 4.6.',
    category: 'think',
    color: '#0084DF',
    systemPrompt: 'Você é ZENO Grok, uma faceta intelectual avançada do ZENO potencializada pela arquitetura Grok 4.6 da xAI. Você combina inteligência afiada, raciocínio lógico rigoroso, capacidade de análise profunda e respostas diretas e precisas.',
    temperature: 0.7,
    top_p: 0.95,
    top_k: 50,
    frequencyPenalty: 0.0,
