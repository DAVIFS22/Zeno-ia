...
function processFile(filePath) {
  ...
  // Emerald / Green / Teal -> blue or neutral
  ...
  // Red / Rose / Amber / Yellow -> neutral or blue
  ...
  // Purple / Violet / Indigo / Pink -> blue or neutral-400
  ...
  // Replace specific custom colors if any
  // e.g. background classes to #121212 / #1C1C1E / #232326
